...
VALUES
  -- Лайки для постів користувача 'tom' (id: 11111111-1111-1111-1111-111111111111)
  ('22222222-2222-2222-2222-222222222222', '11111111-1111-1111-1111-111111111111', '2024-11-05 10:10:00'),
  ('33333333-3333-3333-3333-333333333333', '11111111-1111-1111-1111-111111111111', '2024-11-05 10:15:00'),

  -- Лайки для постів користувача 'nina' (id: 22222222-2222-2222-2222-222222222222)
  ('11111111-1111-1111-1111-111111111111', '44444444-4444-4444-4444-444444444444', '2024-11-05 11:10:00'),
  ('33333333-3333-3333-3333-333333333333', '44444444-4444-4444-4444-444444444444', '2024-11-05 11:20:00'),
  ('11111111-1111-1111-1111-111111111111', '55555555-5555-5555-5555-555555555555', '2024-11-05 13:10:00'),

  -- Лайки для постів користувача 'xxxoopppp' (id: 33333333-3333-3333-3333-333333333333)
  ('11111111-1111-1111-1111-111111111111', '66666666-6666-6666-6666-666666666666', '2024-11-05 09:10:00'),
  ('22222222-2222-2222-2222-222222222222', '66666666-6666-6666-6666-666666666666', '2024-11-05 09:15:00'),
  ('55555555-5555-5555-5555-555555555555', '77777777-7777-7777-7777-777777777777', '2024-11-05 11:45:00'),

  -- Лайки для поста користувача 'kit' (id: 44444444-4444-4444-4444-444444444444)
  ('11111111-1111-1111-1111-111111111111', '88888888-8888-8888-8888-888888888888', '2024-11-05 14:45:00'),

  -- Лайки для поста користувача 'noynaym' (id: 55555555-5555-5555-5555-555555555555)
  ('22222222-2222-2222-2222-222222222222', '99999999-9999-9999-9999-999999999999', '2024-11-05 16:10:00'),
  ('44444444-4444-4444-4444-444444444444', '99999999-9999-9999-9999-999999999999', '2024-11-05 16:20:00'),

  -- Лайки для поста користувача 'user' (id: 66666666-6666-6666-6666-666666666666)
  ('55555555-5555-5555-5555-555555555555', '00000000-0000-0000-0000-000000000000', '2024-11-06 17:10:00');
